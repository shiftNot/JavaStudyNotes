...
public class Test_01_Map基本使用 {
    public static void main(String[] args) {
        ...
        map.put(2, "b");
        map.put(3, "c");
        System.out.println( map.put(4, "c"));//返回null
        System.out.println(map.put(1, "d"));//返回替换前的值
        System.out.println(map);


        //public V remove(Object key): 把指定的键对应的键值对元素在Map集合删除，返回被删除元素的值
        //System.out.println("remove:"+map.remove(4));//返回4对应的值c
        //System.out.println("remove:"+map.remove(5));//返回null
        map.remove(4);
        ...
        //public boolean containKey(Object key):判断该集合中是否有此键。
        System.out.println("containKey:"+map.containsKey(1));
        System.out.println("containKey:"+map.containsKey(4));
